...
public class FrontEnd {
  ...
  private static final String idPrompt = "Enter a " + Student.getLengthofid() + " digit student ID: ";
  private static final String idLengthError = "ID entered must be " + Student.getLengthofid() + " digits, please re-try:";
  ...
  private static final String dollarWarningTooManyDecimals =
    "Value exceeded the hundredths place, truncating decimal: ";
   ...
   */
  private static float getValidDollarAmount(String input) {
    float dollarAmount;
    try {
    ...
    dollarAmount = Float.parseFloat(roundedAmount);
    System.out.println(dollarWarningTooManyDecimals);
    return dollarAmount;
  }
  ...
  private static void tellBalance(Student stud) {
    System.out.println(tellUserAccount(stud) + balancePrompt + "$" + stud.getBalance());
  }
